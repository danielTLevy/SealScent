...
class EnergyModel(nn.Module):
    def __init__(self, n_labels, global_dim, hidden_dim, gnn, lam=1):
    ...
    def forward(self, x_graph, x_feat, y):
        embeddings = self.gnn(x_graph, x_feat)
...
class EnergyModelEmbeddings(nn.Module):
    def __init__(self, n_labels, global_dim, hidden_dim, lam=1):
        super(EnergyModelEmbeddings, self).__init__()
        self.hidden_dim = hidden_dim
        self.global_dim = global_dim
        self.n_labels = n_labels
        self.lam = lam
